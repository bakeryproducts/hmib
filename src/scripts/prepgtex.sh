...
python3 hsrc/data_gen.py --src input/extra/gtex/pieces/spleen_test --dst temp/$DST/gtex_${SCALE}_test/spleen --src_scale .5 --dst_scale $SCALE --cropsize $CROP --recursive --mode inst
